        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-5xl mx-auto">
              ...
              <div className="relative">
                ...
                <div className="mb-6 flex justify-center">
                  <div className="relative group">
                    <div className="w-24 h-24 bg-gradient-to-br from-blue-900/40 via-slate-800/30 to-cyan-900/40 backdrop-blur-sm rounded-full flex items-center justify-center shadow-2xl border border-cyan-400/30 group-hover:scale-105 transition-all duration-500 group-hover:shadow-cyan-400/20 group-hover:shadow-2xl">
                      <img 
                ...
                <div className="space-y-4">
                  <p className="text-sm uppercase tracking-[0.4em] bg-gradient-to-r from-cyan-300 via-blue-400 to-indigo-400 bg-clip-text text-transparent font-semibold animate-pulse">
                    Proudly Presented By
                  </p>
                  <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold bg-gradient-to-r from-slate-200 via-cyan-200 to-blue-200 bg-clip-text text-transparent leading-tight hover:from-cyan-300 hover:via-blue-300 hover:to-indigo-300 transition-all duration-500 cursor-default">
                    Geethanjali College of Engineering & Technologies
                  </h2>
                </div>

                {/* Decorative Elements */}
                <div className="flex justify-center items-center mt-8 space-x-6">
                  <div className="h-px bg-gradient-to-r from-transparent via-cyan-400/60 to-blue-500/60 w-20 sm:w-32 animate-pulse"></div>
                  <div className="relative">
                    <GraduationCap className="w-6 h-6 text-cyan-400 animate-bounce" style={{ animationDuration: '3s' }} />
                    <div className="absolute inset-0 bg-cyan-400/30 rounded-full blur-md animate-ping" />
                  </div>
                  <div className="h-px bg-gradient-to-l from-transparent via-cyan-400/60 to-blue-500/60 w-20 sm:w-32 animate-pulse"></div>
                </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center animate-in fade-in slide-in-from-bottom-4 duration-1000 delay-400">
              <Button asChild size="lg" className="text-lg px-8 py-6 rounded-full bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 text-white shadow-lg hover:shadow-cyan-500/25 transition-all duration-300">
                <Link href="/about">
                  Discover Our Mission
                  <ChevronRight className="ml-2 h-5 w-5" />
                </Link>
              </Button>
              <Button asChild variant="outline" size="lg" className="text-lg px-8 py-6 rounded-full bg-transparent border-2 border-slate-600 text-slate-300 hover:bg-slate-800/50 hover:border-cyan-400/50 hover:text-cyan-300 transition-all duration-300">
                <Link href="/team">
                  Meet Our Team
